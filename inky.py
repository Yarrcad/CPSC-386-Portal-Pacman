...
class Inky(Sprite):
    ...
    def __init__(self, screen, pacman, scoreboard):
        ...
        self.rimages = []
        self.rimages = ss.images_at(((457, 113, 13, 14), (473, 113, 13, 14)), colorkey=(0, 0, 0))
        self.limages = []
        self.limages = ss.images_at(((489, 113, 13, 14), (505, 113, 13, 14)), colorkey=(0, 0, 0))
        self.uimages = []
        self.uimages = ss.images_at(((521, 113, 13, 14), (521, 113, 13, 14)), colorkey=(0, 0, 0))
        self.dimages = []
        self.dimages = ss.images_at(((553, 113, 13, 14), (569, 113, 13, 14),), colorkey=(0, 0, 0))
        self.bimages = []
    ...
    def reset(self):
        self.centery = self.rect.centery = 28.5 * 13
        self.centerx = self.rect.centerx = 23.5 * 13
        self.wait = 360
        self.chase = False
        if (random.randint(0,1) == 0):
            self.direction = "left"
